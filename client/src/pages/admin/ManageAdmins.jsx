      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl font-semibold text-fg mt-1">Admins</h1>
          </div>
          {!showForm && (
            <button
        ...
        {showForm && (
          ...
          >
            <h2 className="text-sm font-semibold text-fg mb-4">New Admin</h2>
        ...
        {loading ? (
          ...
          <p className="text-sm text-fg-subtle text-center py-10">No admins yet.</p>
        ) : (
          <motion.div
            className="space-y-2"
            initial="hidden"
