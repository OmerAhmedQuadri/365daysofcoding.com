      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl font-semibold text-gray-900 mt-1">Instructors</h1>
          </div>
          {!showForm && (
            <button
        ...
        {showForm && (
          ...
          >
            <h2 className="text-sm font-semibold text-gray-800 mb-4">New Instructor</h2>
        ...
        {loading ? (
          ...
          <p className="text-sm text-gray-400 text-center py-10">No instructors yet.</p>
        ) : (
          <motion.div
            className="space-y-2"
            initial="hidden"
